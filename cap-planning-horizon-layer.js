(function(){
  ...
  async function load(){
    try{const remote=await api('/api/planning-horizon?days=7');if(remote?.calendar){render(remote);window.dispatchEvent(new CustomEvent('cap:planning-horizon',{detail:remote}));return remote;}}catch(e){}
