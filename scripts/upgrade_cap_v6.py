...
s=s.replace("const APP_VERSION='Final Production 5.0';","const APP_VERSION='CAP Delivery 6.1 · Esselunga TP Control';")
s=s.replace("const APP_VERSION='CAP Delivery 6.0 · Operations Intelligence';","const APP_VERSION='CAP Delivery 6.1 · Esselunga TP Control';")
if s==orig:
    print('CAP V6.1 patch already applied')
else:
    p.write_text(s,encoding='utf-8')
    print('CAP V6.1 patch applied')
for marker in ['cap-ops-layer.css','cap-ops-core.js','cap-ops-layer.js','cap-tp-route-layer.css','cap-tp-route-layer.js','CAP Delivery 6.1 · Esselunga TP Control']:
